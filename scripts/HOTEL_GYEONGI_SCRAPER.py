...
from scripts.HOTEL_URL import HOTEL_GYEONGGI
...
def run():
    ...
    GYEONGGI_URL = HOTEL_GYEONGGI
    res = requests.get(GYEONGGI_URL)
    ...
    for img, item in zip(imgs, contents):
        ...
        category = HotelCategory.objects.get(name='경기도')
